...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0 .frenchkiss:nth-child(1) {
      background: #FFFFFF;
      box-shadow: 0 2px 0 2px #BDC2C4;
    }

    .c0 .frenchkiss:nth-child(2) {
      left: 0;
      top: -3px;
    ...
    .c0 .frenchkiss:nth-child(3):before,
    .c0 .frenchkiss:nth-child(3):after {
      content: "";
      position: absolute;
      background: #ef8927;
      border-radius: 20px;
    ...
    .c1:focus + label {
      box-shadow: 0px 0px 0px 1px #BD1C3F,0px 0px 0px 4px rgba(118,69,217,0.6);
    }

    .c1:checked + label .frenchkisses {
      -webkit-transform: translateX(34px);
      -ms-transform: translateX(34px);
      transform: translateX(34px);
    }

    .c1:checked + label .frenchkiss:nth-child(1) {
      background: #e27c31;
      box-shadow: 0 2px 0 2px #fbbe7c;
    ...
    .c1:checked + label .frenchkiss:nth-child(2) {
    ...
    .c1:checked + label .frenchkiss:nth-child(3) {
      -webkit-transform: scale(1);
      -ms-transform: scale(1);
      transform: scale(1);
    ...
    <div
      ...
      >
        <input
          checked=""
          class="c1"
          id="frenchkiss-toggle"
          scale="md"
          type="checkbox"
        />
        <label
          class="c2"
          for="frenchkiss-toggle"
          scale="md"
        >
          <div
            class="frenchkisses"
