...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.frenchkiss-button--disabled):not(.frenchkiss-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.frenchkiss-button--disabled):not(.frenchkiss-button--disabled) {
      opacity: 0.85;
    ...
    .c12:hover:not(:disabled):not(.frenchkiss-button--disabled):not(.frenchkiss-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c12:active:not(:disabled):not(.frenchkiss-button--disabled):not(.frenchkiss-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c12:disabled,
    .c12.frenchkiss-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
